...
import java.util.concurrent.locks.Lock;
 ...
 public class ZKDistributedLock  {
    ...
    /*private ZooKeeper zk = null;  test111
    ...
    public ZKDistributedLock(String config, String lockName){
        *//*this.lockName = lockName;
        try {
          ...
          if (stat == null) {
            zk.create(ROOT_LOCK, new byte[0], ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT);// 如果根节点不存在，则创建根节点
          }
        } catch (IOException e) {
          e.printStackTrace();
